...
function Notifications() {
  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      <Transition
        className="origin-top-right z-10 absolute top-full w-100 right-10 -mr-16 sm:mr-0 min-w-80 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        show={dropdownOpen}
          ...
          <ul>
            <li className="border-b border-gray-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣  &nbsp;<span className="font-medium text-gray-800">Pondr has launched!</span> Check out all of our new features and major UI updates to give you the best experience. Have any questions? Fill out the contact form below.</span>
                <span className="block text-xs font-medium text-gray-400">June 23rd, 2021</span>
              </Link>
            </li>
          </ul>
        </div>
